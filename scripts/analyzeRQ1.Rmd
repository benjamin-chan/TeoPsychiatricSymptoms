...
chisqTable("indPHQ", "fmss_r2", varlabel = varlabel)[c("table", "expected", "chisq.test")]
...
chisqTable("indDSISS", "fmss_r2", varlabel = varlabel)[c("table", "expected", "chisq.test")]
...
```{r}
x <- "fmss_r1 + fmss_r2 + fmss_r3 + fmss_r11"
```
