...
chisqTable("comm_facebook", "fb_freq", data = df2, varlabel = varlabel)
chisqTable("comm_facebook", "comm_inperson", data = df2, varlabel = varlabel)
chisqTable("fb_freq", "comm_inperson", data = df2, varlabel = varlabel)
```
...
varlabel <- data.frame(name = c("fmss_r1", "fmss_r3", "fmss_r11", "indPHQ", "indDSISS"),
                       ...
                       stringsAsFactors = FALSE)
chisqTable("indPHQ", "fmss_r1", varlabel = varlabel)
chisqTable("indPHQ", "fmss_r3", varlabel = varlabel)
chisqTable("indPHQ", "fmss_r11", varlabel = varlabel)
chisqTable("indDSISS", "fmss_r1", varlabel = varlabel)
chisqTable("indDSISS", "fmss_r3", varlabel = varlabel)
chisqTable("indDSISS", "fmss_r11", varlabel = varlabel)
```
