...
```{r}
x <- "fmssZ"
df0 %>% select(fmss, fmssZ) %>% cov(use = "pairwise.complete.obs") %>% sqrt() * diag(2)
...
chisqTable("comm_facebook", "fb_freq", data = df2, varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("comm_facebook", "comm_inperson", data = df2, varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("fb_freq", "comm_inperson", data = df2, varlabel = varlabel)[c("table", "expected", "chisq.test")]
```
...
```{r}
varlabel <- data.frame(name = c("fmss_r1", "fmss_r3", "fmss_r11", "indPHQ", "indDSISS"),
                       ...
                       stringsAsFactors = FALSE)
chisqTable("indPHQ", "fmss_r1", varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("indPHQ", "fmss_r3", varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("indPHQ", "fmss_r11", varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("indDSISS", "fmss_r1", varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("indDSISS", "fmss_r3", varlabel = varlabel)[c("table", "expected", "chisq.test")]
chisqTable("indDSISS", "fmss_r11", varlabel = varlabel)[c("table", "expected", "chisq.test")]
```

```{r}
x <- "fmss_r1 + fmss_r3 + fmss_r11"
```
...
chisqTable("indPHQ", "fmssQuartile", data = df3, varlabel = varlabel)
chisqTable("indDSISS", "fmssQuartile", data = df3, varlabel = varlabel)
```
